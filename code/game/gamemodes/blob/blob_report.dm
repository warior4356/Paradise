		...
		if(2)
			...
			for(var/mob/living/silicon/ai/aiPlayer in GLOB.player_list)
				if(aiPlayer.client)
					...
					var/law = "The station is under quarantine. Do not permit anyone to leave. Disregard all lower laws if necessary to prevent, by any means necessary, anyone from leaving. The nuclear failsafe must be activated at any cost, the codes are in your notes."
